...
/**
  ...
  * @param signalsFunction The signal function accepts a set of neurons and returns the strength of the signal to send
  *                        to each neuron as a ``map(neuron -> signal_strength)``
